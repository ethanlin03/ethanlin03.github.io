            ...
            {leftOrRight === "right" ? (
                <div className="relative flex flex-row items-top left-[34px]">
                    ...
                    <div className="flex flex-row">
                        <motion.div initial={{ opacity: 0, x: 20, z: 0 }} whileInView={{ opacity: 1, x: 0, z: 0 }} transition={{ duration: 1.2, ease: "easeOut" }} viewport={{ once: false }}
                            className="w-0 h-0 border-t-[10px] border-b-[10px] border-r-[10px] border-t-transparent border-b-transparent border-r-gray-500 mt-8"
                        />
